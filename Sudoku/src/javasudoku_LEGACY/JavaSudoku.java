...
//        });
//</editor-fold>
//<editor-fold defaultstate="collapsed" desc="temp assign">
/*
...
//</editor-fold>
    ...
    static void eliminateBy(Predicate predicate) {
        ...
        if (removeFromCandidates.size() == global.NUMRANGE) //JAK ZJISTIT KTERY PREDIKAT VOLAM? a co ty CONSUMABLES?** DEBUG v tomto bode = SOLVED????? 
        {
